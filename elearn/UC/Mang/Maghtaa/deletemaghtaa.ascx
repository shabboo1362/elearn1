<%@ Control Language="C#" AutoEventWireup="true" CodeFile="deletemaghtaa.ascx.cs" Inherits="UC_Mang_Maghtaa_deletemaghtaa" %>
...
<td style="text-align: right ;font-family:Arial; font-size:12pt ; font-weight:bold ;">
    <span style="color: #ff0000">توجه</span>:با حذف یک مقطع تمام اطلاعات آن از سیستم حذف می شود . 
