<%@ Control Language="C#" AutoEventWireup="true" CodeFile="addmaster.ascx.cs" Inherits="UC_Mang_master_addmaster" %>
...
<td align ="right" dir="rtl" >
    ...
    <tr>
        <td style="width: 204px">
            ش ش :</td>
        <td align="right">
            <asp:TextBox ID="shshtxt" runat="server" Width="108px"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="shshtxt"
                ErrorMessage="فيلدهاي ستاره دار را وارد كنيد.">*</asp:RequiredFieldValidator></td>
    </tr>
    <tr>
        <td style="width: 204px">
    ...
    <tr>
        <td style="width: 204px">
            نام پدر :</td>
        <td align="right">
            <asp:TextBox ID="fathertxt" runat="server" Width="110px"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="fathertxt"
                ErrorMessage="فيلدهاي ستاره دار را وارد كنيد.">*</asp:RequiredFieldValidator></td>
    </tr>
   <tr>
   ...
   <td style="height: 40px">
    ...
    <tr>
        <td style="width: 204px; height: 40px">
            رشته تحصيلي :</td>
        <td style="height: 40px">
            <asp:TextBox ID="reshtetxt" runat="server" Width="110px"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="reshtetxt"
                ErrorMessage="فيلدهاي ستاره دار را وارد كنيد.">*</asp:RequiredFieldValidator></td>
    </tr>
    <tr>
        <td style="width: 204px; height: 40px">
    ...
    <tr>
        <td style="width: 204px; height: 40px">
            آخرين مدرك تحصيلي:</td>
        <td style="height: 40px">
            <asp:TextBox ID="lastgradetxt" runat="server" Width="110px"></asp:TextBox><asp:RequiredFieldValidator
                ID="RequiredFieldValidator7" runat="server" ControlToValidate="lastgradetxt"
                ErrorMessage="فيلدهاي ستاره دار را وارد كنيد.">*</asp:RequiredFieldValidator></td>
    </tr>
    <tr>
        <td style="width: 204px; height: 40px">
    نوع كاربر :</td>
        <td style="height: 40px">
            <asp:DropDownList ID="usertypeddl" runat="server" Width="184px">
            <asp:ListItem Text ="معاون- دفتر دار "  Value ="asistant" ></asp:ListItem>
            <asp:ListItem Text ="معلم - مدرس"  Value ="teacher" ></asp:ListItem>
            <asp:ListItem Text ="دانش آموز - دانشجو"  Value ="student" ></asp:ListItem>
</asp:DropDownList></td>
    </tr>
<tr>
