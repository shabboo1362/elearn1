<%@ Control Language="C#" AutoEventWireup="true" CodeFile="deleteecourse.ascx.cs" Inherits="UC_Mang_ecourse_deleteecourse" %>
...
<td style="text-align: right ;font-family:Arial; font-size:12pt ; font-weight:bold ;">
    <span style="color: #ff0000">توجه</span>:با حذف یک&nbsp; درس تمام اطلاعات آن از سیستم حذف می شود . 
